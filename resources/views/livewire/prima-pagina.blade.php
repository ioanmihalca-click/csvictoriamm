<div>
    ...
    <section class="relative bg-center bg-cover" style="background-image: url('assets/unsplash-image.webp')">
        ...
        <div class="container relative z-10 px-4 py-8 mx-auto">
            <h1 class="mb-4 text-4xl font-bold text-center text-black md:text-6xl md:text-left font-roboto-condensed">
                Club Sportiv <br class="md:hidden"> Victoria
                Maramureș</h1>
            <h2 class="max-w-2xl p-2 mb-8 text-xl font-semibold text-center text-black md:text-left md:text-2xl">Promovăm
                sportul de
                <span class="font-bold text-red-900">performanță</span> și sportul pentru toți în Baia-Mare, Poienile de
                sub Munte și Petrova. Antrenamente de
                <span class="font-bold text-red-900">Freestyle Kickboxing</span> și Fitness Funcțional în Baia Mare |
                Grupe de copii si adulti.
            </h2>
            ...
            <div class="flex flex-col md:flex-row md:space-x-12">
                    ...
                    <div x-data="{ currentImage: 0 }" class="space-y-8">
                        ...
                        <div class="flex flex-col justify-center mt-4 space-y-2 sm:flex-row sm:space-y-0 sm:space-x-4">
                            <button @click="currentImage = 0"
                                ...
                                :class="{
                                    'bg-red-900 text-white': currentImage ===
                                        0,
                                    'bg-gray-200 text-gray-700 hover:bg-gray-300': currentImage !== 0
                                }">
                                Antrenamente Adulți
                            </button>
                            <button @click="currentImage = 1"
                                ...
                                :class="{
                                    'bg-red-900 text-white': currentImage ===
                                        1,
                                    'bg-gray-200 text-gray-700 hover:bg-gray-300': currentImage !== 1
                                }">
                                Antrenamente Copii
                            </button>
                        </div>
                ...
                <div class="w-full mt-8 md:w-2/3 md:mt-0">
                    ...
                    <div class="space-y-4 text-lg" x-data="{ expanded: false }">
                        ...
                        <p class="mb-4 text-xl">Ceea ce a început ca un club mic, pasionat de artele marțiale, a evoluat
                        ...
                        <div x-show="expanded" x-transition:enter="transition ease-out duration-300"
                            ...
                            <p class="mb-4 text-xl">Suntem afiliati ai <strong>Federatiei Romane de Freestyle
                                    Kickboxing</strong> si participam anual la competitii nationale si internationale.
                                Am castigat multe medalii și trofee prețioase, dar cea mai mare realizare a noastră
                            ...
                            <p class="mb-4 text-xl">Suntem profesioniști dedicați, cu experiență în domeniu si
                                certificări naționale relevante. Ne concentram pe furnizarea celor mai bune sesiuni de
                            ...
                            <p class="mb-4 text-xl">Promovăm <strong>kickboxingul</strong> de
                                <strong>performanță</strong> și <strong>sportul pentru toți</strong>, promovăm in
                                comunitatea noastra un stil de viață mai sănătos și activ prin antrenamente de
                                autoaparare. Ne gasesti in Baia-Mare, Poienile de sub Munte si Petrova.
                            </p>
                            <p class="mb-4 text-xl">Organizăm sesiuni de probă gratuite în fiecare zi.</p>
                        </div>
                        <button @click="expanded = !expanded"
                            class="px-4 py-2 mt-4 text-white transition-colors duration-300 bg-red-900 rounded hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-800 focus:ring-opacity-50">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <ul class="list-disc list-inside">
                                <li>Luni și Miercuri, 18:30 - Grupa copii (6-12 ani)</li>
                                <li>Luni și Miercuri, 19:35 - Grupa adulți și juniori mari</li>
                            </ul>
    ...
    <!-- Parallax Section -->
    <section class="relative bg-fixed bg-center bg-cover h-96"
            ...
            <div class="grid gap-12 md:grid-cols-3">
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-lg">Pregătirea noastră temeinică, combinată cu pasiunea și dăruirea, se reflectă
                    ...
                    <div>
                        ...
                        <p class="text-lg">Creăm o atmosferă bazată pe respect reciproc, încurajând membrii să se simtă
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-lg">Oferim un mediu optim pentru antrenament și progres, cu o sală special
                            amenajată și toate echipamentele necesare.</p>
                    </div>
                    <div>
                        <h3 class="mb-3 text-2xl font-semibold text-red-900">Progres Constant și Dezvoltare Personală
                        </h3>
                        <p class="text-lg">Ne concentrăm pe dezvoltarea fiecărui sportiv, îmbunătățind nu doar
