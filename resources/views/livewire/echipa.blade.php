...
<div class="relative py-20 overflow-hidden bg-white">
    ...
    <div class="relative px-8 mx-auto md:px-16 max-w-7xl">
        <p class="font-semibold tracking-wide text-red-900 uppercase font-roboto-condensed">Conducere, echipa tehnica, management si membri de onoare</p>
        <h2 class="relative max-w-lg mt-5 mb-10 text-4xl font-semibold leading-tight lg:text-5xl">Ei sunt coloana vertebrala a acestui club</h2>
